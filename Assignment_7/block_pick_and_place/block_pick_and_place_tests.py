...
class BlockPushingTestSuite(unittest.TestCase):
    ...
    def test_gripper_to_block_pose(self):
        ...
        gripper_pose_true = np.array(
            [
                [0.7109135, 0.7032794, 0.0, 0.05],
                [0.0, 0.0, -1.0, 0.065],
                [-0.7032794, 0.7109135, 0.0, -0.5],
                [0.0, 0.0, 0.0, 1.0],
            ]
        )
    ...
    def test_ik(self):
        des_pose = np.array(
            [
                [1.0000000, 0.0000000, 0.0000000, 0.1],
    ...
    def test_lcm(self):
        ...
        transform_error = transform_utils.transform_error(
            true_transform, panda.goal_pose
        )
